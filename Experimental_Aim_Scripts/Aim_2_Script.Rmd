...
filtered_stat <- statistical_table |>
  filter(`diff_robust_groupControl Depression` == "TRUE" |
                `diff_robust_groupPMS` == "TRUE" |
`diff_robust_groupPMS Depression` == "TRUE" |
 `diff_robust_groupRRMS` == "TRUE" |
`diff_robust_groupRRMS Depression` == "TRUE")  
